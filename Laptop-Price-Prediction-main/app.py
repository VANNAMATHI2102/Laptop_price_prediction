...
if st.button('Predict Price'):
    ...
    # Manually setting exchange rate (approximate value)
    exchange_rate = 2.5  # 1 USD = 75 INR

    # Converting the predicted price from USD to INR
    predicted_price_inr = round(predicted_price * exchange_rate, 2)

    # Display the result
    st.title(f"\nPrice: {predicted_price_inr} INR")
